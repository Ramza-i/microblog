...
class User(UserMixin, db.Model):
    ...
    avatar = db.Column(db.String(120), default='def_ava.jpg')
    ...
    def get_reset_password_token(self, expires_in=600):     #expires_in=600 - время жизни токена в секундах
        return jwt.encode({'reset_password': self.id, 'exp': time() + expires_in},
                          current_app.config['SECRET_KEY'], algorithm='HS256')      #.decode('utf-8')#decode('utf-8') - заменят строку байтов на строку символов
